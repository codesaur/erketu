...
class File
{
    ...
    public function getAllowed(int $type = 0): array
    {
        switch ($type) {
            case 1:
                return ['xls', 'xlsx', 'pdf', 'doc', 'docx', 'ppt', 'pptx', 'pps', 'ppsx', 'odt'];
            case 2:
                return ['mp3', 'm4a', 'ogg', 'wav', 'mp4', 'm4v', 'mov', 'wmv', 'swf'];
            case 3:
                return ['jpg', 'jpeg', 'jpe', 'png', 'gif'];
            case 4:
                return ['ico', 'bmp', 'txt', 'xml', 'json'];
            case 5:
                return ['zip', 'rar'];
    ...
    public function isImage(string $path): bool
    {
        ...
        $image_types =  array('image/png', 'image/ico', 'image/svg', 'image/bmp', 'image/gif', 'image/jpeg');
